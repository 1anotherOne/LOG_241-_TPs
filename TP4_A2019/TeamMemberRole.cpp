...
{
	// A Completer
	return m_member.get()->getName();
}

void TeamMemberRole::setName(std::string name)
{
	// A Completer
	m_member.get()->setName(name);
}
